...
The program is composed of two folders. [One](ML_Convertion-Python_To_StructuredText
/Decision Tree) One for the convertion of decision tree algorithms, and the other for the convertion of multilayer perceptron algorithms. Each folder is composed of two files: *Main* and *Function*.
