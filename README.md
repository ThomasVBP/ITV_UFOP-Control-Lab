...
The program is composed of two folders. [One]([url](https://www.sciencedirect.com/journal/softwarex/publish/guide-for-authors#17106)) for the convertion of decision tree algorithms, and the other for the convertion of multilayer perceptron algorithms. Each folder is composed of two files: *Main* and *Function*.
